								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											<center><h4 class="header lighter bigger blue"  style="font-size:15px;">
											...
											<form method="post" action="main/confirmlogin.php">
												<fieldset>
								...
								<div id="forgot-box" class="forgot-box widget-box no-border">
									<div class="widget-body" style="background-color:white;">
										<div class="widget-main">
											...
											<form method="get" action="main/forgotpassword.php?emailforforgotpass">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" class="form-control" placeholder="Email" name="emailforforgotpass"/>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="main/register.php">
												<fieldset>
                                                  <center><label class="block clearfix">
											 ...
											 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        <span class="input-icon input-icon-right">
															<input id="username" name="uname" type="text" class="form-control" placeholder="Username" onChange="checkUsername()" />
															<i class="ace-icon fa fa-user"></i>
														</span>
                            							<span>
													...
													<label class="block clearfix">
															<span class=" block input-icon input-icon-right">
															<input id="emailAddress" type="email" class="form-control" name="email" placeholder="Email" onChange="checkEmailAddress()" required/>
															<i class="ace-icon fa fa-envelope"></i>
														</span>
														<span>
													...
													<?php //label class="block">
														//<input type="checkbox" class="ace" />
														//<span class="lbl">
															//I accept the
															//<a href="#">User Agreement</a>
														//</span>
													//</label><div class="space-24"></div>
													?>
