<?php
 session_start(); 
	function get_data() {
        ...
        $query="Select * FROM post_details INNER JOIN posts ON post_details.post_no = posts.post_no INNER JOIN courses ON courses.class_code=posts.class_code where post_details.student_account_no='$student_account_no' and post_type='announcement' ";
	...
	$file_name = 'reloadTableAnnouncement.json';
