			...
			<?php
                                                                       ...
                                                                       $qry = mysqli_query ($connection, $sql) or die (mysqli_error($connection));
                                                                        if ($record = mysqli_fetch_assoc($qry))
                                                                        {
                                                                            ...
                                                                            $street = $record["admin_street/brgy"];
                                                                            $prov = $record["admin_province/city"];
										...
										<div class="btn-toolbar inline middle no-margin">
											<div data-toggle="buttons" class="btn-group no-margin">
												...
												<label class="btn btn-sm btn-yellow active">
													<span class="bigger-110">My Profile</span>
												...
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
                                                                <!--id="avatar2"-->
                                                                <?php $src = "../../assets/images/admin/profilepics/".$fname.".jpg"; ?>
																<img class="editable img-responsive" alt="Alex's Avatar"  src="<?php echo $src; ?>" />
															</span>
														...
														<div class="col-xs-12 col-sm-9">
															...
															<div class="profile-user-info">
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<a href="#" target="_blank">www.tanshong.com</a>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<a href="https://www.facebook.com/tanshongisreal">Find me on Facebook</a>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<a href="https://www.twitter.com/tanshongshony">Follow me on Twitter</a>
																	</div>
																</div>
															</div>
														</div><!-- /.col -->
