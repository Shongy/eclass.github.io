...
<head runat="server">
    ...
    <?php
      ...
      ?>
        ...
        function f3() {
            document.getElementById("starttime").innerHTML = "You stop at " + f.getHours() + ":" + f.getMinutes();
            min = 00;
            sec = 00;
            f2();
        }
      ...
      <table width="100%" align="center">
        ...
        <tr>
          <td>
            ...
            <div id="showtime"></div>
              <input onclick="f1()" value="CLICK ME TO START" type="button" >
              <input onclick="f3()" value="CLICK ME TO STOP" type="button" >
